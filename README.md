...
-I successfully added a third-party service endpoint. I ended up just using the quote generator that we learned from the Simon deliverable
-I created service endpoints running under Node.js
-I was unable to figure out how to get my startup to communicate with MongoDB, though. I kept running into roadblocks and was unable to figure it out...
-I was unable to implement the Websockets. I wasn't able to debug it properly to get it working...
